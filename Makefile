...
release/quake2 : CFLAGS += -DUSE_OPENAL -DDEFAULT_OPENAL_DRIVER='"libopenal.dylib"' -I/opt/local/include/AL
release/quake2 : LDFLAGS += -L/opt/local/lib -rpath /opt/local/lib
else
